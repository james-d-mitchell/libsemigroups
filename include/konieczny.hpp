...
namespace libsemigroups {
  ...
  //! This struct provides a call operator for obtaining a hash value for the
  //! vector.
  // TODO(now) Replace this with specalization of Hash
  struct VecBMat8Hash {
  ...
  class Konieczny::BaseDClass {
   ...
   public:
    ...
    std::vector<BMat8> covering_reps() {
      ...
      // std::cout << "found " << detail::to_string(out.size())
  ...
  class Konieczny::RegularDClass : public Konieczny::BaseDClass {
   ...
   private:
    ...
    void compute_left_indices() {
      ...
      size_t row_scc_id    = _parent->_row_orb.digraph().scc_id(row_basis_pos);
      size_t col_scc_id    = _parent->_col_orb.digraph().scc_id(col_basis_pos);
  ...
  class Konieczny::NonRegularDClass : public Konieczny::BaseDClass {
   ...
   private:
    ...
    void compute_H_class() {
      ...
      std::unordered_set<std::vector<BMat8>, VecBMat8Hash> Hxhw_set;
      std::unordered_set<std::vector<BMat8>, VecBMat8Hash> zhHx_set;
  ...
  void Konieczny::compute_D_classes() {
    ...
    // std::cout << "next card: " << detail::to_string(*cards.rbegin())
    //          << std::endl;
